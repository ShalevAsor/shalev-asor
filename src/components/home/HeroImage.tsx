...
//         <div className="absolute -top-4 -left-4 w-24 h-24 border-l-2 border-t-2 border-primary"></div>
//         <div className="absolute -bottom-4 -right-4 w-24 h-24 border-r-2 border-b-2 border-accent"></div>

//         {/* Floating accent squares */}
//         <div className="absolute -top-8 -right-8 w-16 h-16 bg-primary/20 backdrop-blur-sm"></div>
//         <div className="absolute -bottom-8 -left-8 w-12 h-12 bg-accent/20 backdrop-blur-sm rotate-45"></div>
...
//           {/* Framed image */}
//           <div className="relative w-80 h-96 lg:w-96 lg:h-[28rem] rounded-lg overflow-hidden border-2 border-primary/20 shadow-2xl">
//             <Image
...
//           {/* Tech stack badges */}
//           <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 flex gap-2 bg-card/80 backdrop-blur-sm px-4 py-2 rounded-full border border-border">
//             <span className="text-xs font-mono text-primary">React</span>
//             <span className="text-xs text-muted-foreground">•</span>
//             <span className="text-xs font-mono text-accent">Next.js</span>
//             <span className="text-xs text-muted-foreground">•</span>
